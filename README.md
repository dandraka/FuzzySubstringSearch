...
## What does 'Sequential Search' mean?

Sequential search, in this context, means that as soon as a part of search string is found, 
subsequect searches look only for the rest of the search string.
